...
class AppStrings extends ChangeNotifier {
  ...
  static final Map<String, Map<String, String>> _map = {
    'en': {
      ...
      'flagged_logins': 'Flagged logins',
      'trusted_devices': 'Capped accounts',
      ...
      'approve': 'Approve',
      'remove': 'Remove',
      'no_flagged': 'No flagged logins.',
      'no_devices': 'No accounts are at the device limit right now.',
      'confirm_remove': 'Remove {email} from "{title}"? This revokes their access.',
      'confirm_remove_device': "Remove this device for {email}? They'll be able to log in on a new device again.",
      'alert_approve_failed': 'Failed to approve: ',
      'alert_remove_failed': 'Failed to remove: ',
      'alert_proof_failed': 'Failed to load proof: ',
      'alert_remove_device_failed': 'Failed to remove device: ',
    },
    'ar': {
      'app_name': 'Site & Structure',
