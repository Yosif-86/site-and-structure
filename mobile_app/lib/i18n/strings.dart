...
class AppStrings extends ChangeNotifier {
  ...
  static final Map<String, String> _map = {
    ...
    'home_continue_learning': 'متابعة التعلم',
    // Home header / progress
    'greeting_morning': 'صباح الخير',
    'greeting_evening': 'مساء الخير',
    'greeting_guest': 'أهلاً بك',
    'greeting_sub': 'واصل تطوير مهاراتك.',
    'greeting_guest_sub': 'سجّل الدخول لمتابعة دوراتك وتقدّمك.',
    'progress_title': 'تقدّمك',
    'progress_complete': 'مكتمل',
    'progress_overall': 'الإجمالي',
    'progress_courses_in_progress': 'دورات قيد التعلّم',
    'view_all': 'عرض الكل',
    'nav_explore': 'استكشاف',
    'lessons_label': 'درس',
    ...
    'dur_min': 'د',
    // Explore
    'explore_search_hint': 'ابحث عن دورة أو مدرّس',
    'explore_no_results': 'لا توجد دورات مطابقة لبحثك.',
    'explore_results': 'دورة',
    'filter_all': 'الكل',
    'filter_paid': 'مدفوع',
    'btn_clear': 'مسح',
    // My courses
    'my_courses_sub': 'تابع رحلة تعلّمك',
    'status_in_progress': 'قيد التعلّم',
    'status_completed': 'مكتملة',
    'empty_completed': 'لم تُكمل أي دورة بعد. استمر!',
    'empty_pending': 'لا توجد طلبات بانتظار الموافقة.',
    ...
    // Course page
    'course_not_found': 'لم يتم العثور على هذه الدورة.',
    'start_course': 'ابدأ الدورة',
    'instructor': 'المدرّس',
    'tab_overview': 'نظرة عامة',
    'about_course': 'عن الدورة',
    'what_you_learn': 'ماذا ستتعلّم',
    'feature_learn_anywhere': 'تعلّم من أي مكان',
    'feature_protected': 'محتوى محمي',
    'status_enrolled': 'أنت مسجّل في هذه الدورة',
    'learning_points_hint': 'نقطة واحدة في كل سطر',
    'learning_points_helper': 'حتى 12 نقطة تظهر في صفحة الدورة',
    'home_featured': 'دورة مميزة',
    'home_all_courses': 'جميع الدورات',
    'lecture_n': 'محاضرة',
